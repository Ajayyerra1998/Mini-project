            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {

                    {
                        ...
                        Intent intent =new Intent(mech.this,Mech_1stYear.class);
                    ...
                    if(f == 1)//open Subjects activity
                    {
                        ...
                        Intent intent =new Intent(mech.this,Mech_2ndYear.class);
                        startActivity(intent);
                    }
                    if(f == 2)//open Subjects activity
                    {

                        Intent intent =new Intent(mech.this,Mech_3rdYear.class);
                        startActivity(intent);
                    }
                    if(f == 3)//open Subjects activity
                    {

                        Intent intent =new Intent(mech.this,Mech_4thYear.class);
                        startActivity(intent);
                    }

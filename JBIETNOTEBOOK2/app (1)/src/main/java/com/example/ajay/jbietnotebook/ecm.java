...
public class ecm extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ecm2);
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {

                    {
                        ...
                        Intent intent =new Intent(ecm.this,Ecm_1stYear.class);
                    ...
                    if(f == 1)//open Subjects activity
                    {
                        ...
                        Intent intent =new Intent(ecm.this,Ecm_2ndYear.class);
                        startActivity(intent);
                    }
                    if(f == 2)//open Subjects activity
                    {

                        Intent intent =new Intent(ecm.this,Ecm_3rdYear.class);
                        startActivity(intent);
                    }
                    if(f == 3)//open Subjects activity
                    {

                        Intent intent =new Intent(ecm.this,Ecm_4thYear.class);
                        startActivity(intent);
                    }

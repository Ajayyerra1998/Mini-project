            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {

                    {
                        ...
                        Intent intent =new Intent(eee.this,EEE_1stYear.class);
                    ...
                    if(f == 1)//open Subjects activity
                    {
                        ...
                        Intent intent =new Intent(eee.this,EEE_2ndYear.class);
                        startActivity(intent);
                    }
                    if(f == 2)//open Subjects activity
                    {

                        Intent intent =new Intent(eee.this,EEE_3rdYear.class);
                        startActivity(intent);
                    }
                    if(f == 3)//open Subjects activity
                    {

                        Intent intent =new Intent(eee.this,EEE_4thYear.class);
                        startActivity(intent);
                    }

            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v)
                {
                    ...
                    if (f == 0)
                    {
                        ...
                        Intent intent =new Intent(cse.this,Cse_1stYear.class);
                    ...
                    if(f == 1)//open Subjects activity
                    {
                        ...
                        Intent intent =new Intent(cse.this,Cse_2ndYear.class);
                        startActivity(intent);
                    }
                    if(f == 2)//open Subjects activity
                    {

                        Intent intent =new Intent(cse.this,Cse_3rdYear.class);
                        startActivity(intent);
                    }
                    if(f == 3)//open Subjects activity
                    {

                        Intent intent =new Intent(cse.this,Cse_4thYear.class);
                        startActivity(intent);
                    }
